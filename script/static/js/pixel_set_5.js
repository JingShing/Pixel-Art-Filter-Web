...
function save_pixel_set_to_local_storage(){
    ...
    for(let i = 0;i<session_set.length;i++)if(document.getElementById(session_set[i]) && document.getElementById(session_set[i]))sessionStorage.setItem(session_set[i], document.getElementById(session_set[i]).value);
}
function load_pixel_set_to_local_storage(){
    ...
    for(let i = 0;i<session_set.length;i++)if(document.getElementById(session_set[i]) && sessionStorage.getItem(session_set[i]))document.getElementById(session_set[i]).value=sessionStorage.getItem(session_set[i])
