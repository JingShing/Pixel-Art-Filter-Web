...
function save_pixel_set_to_local_storage(){
    ...
    // for(let i = 0;i<session_set.length;i++)if(document.getElementById(session_set[i]) && document.getElementById(session_set[i]))localStorage.setItem(session_set[i], document.getElementById(session_set[i]).value);
}
function load_pixel_set_to_local_storage(){
    ...
    // for(let i = 0;i<session_set.length;i++)if(document.getElementById(session_set[i]) && localStorage.getItem(session_set[i]))document.getElementById(session_set[i]).value=localStorage.getItem(session_set[i])
